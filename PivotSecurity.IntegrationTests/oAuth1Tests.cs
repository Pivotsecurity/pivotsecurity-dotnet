...
using PivotSecurity.Authenticators.OAuth;
using PivotSecurity.IntegrationTests.Models;
...
namespace PivotSecurity.IntegrationTests
{
    ...
    public class OAuth1Tests
    {
        ...
        {
            // To pass this test, place a file config.json in the PivotSecurity.IntegrationTests folder
        ...
        public void Use_RFC_3986_Encoding_For_Auth_Signature_Base()
        {
            ...
            var reservedCharacterString = string.Join(string.Empty,
